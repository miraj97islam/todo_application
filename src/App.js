      ...
      <div className='container'>
        ...
        <div className='notepad-container'>
         ...
         <div className='tab-buttons'>
                <button onClick={()=>handleTabs('elementInput')} id="btn-task" className='btn-tasks'>My Tasks</button>
                <button onClick={()=>handleTabs('elementTextArea')} id="btn-note" className='btn-notes'>My Notes</button>
        </div>
